...
// initialize session
session_start();
include("functions/authenticate_colaboradores.php");
    ...
    <div class="container text-center">
	   <center>
	       <div class="card-container" style="width: 25rem;">
                ...
                <form class="form-signin" action="form_colaborador.php" method="post">
                    ...
                    <div>
                        <a target="_blank" href="https://account.activedirectory.windowsazure.com/changepassword.aspx/">Para acceder al sistema de ayuda, debe hacerlo con las mismas credenciales de su computadora.
Si no recuerda su clave visite el siguiente link.</a>

                    </div>
                    <div>
                        <br/>
                    <p><a target="_self" href="https://soporte.aiep.cl/support/scp">Si usted es agente visite el siguiente link.</a></p>
           </div>
